...
public class CreateOrderWCC2 {
	...
	@DataProvider(name = "createOrderProvider")
	...
	public void beforeTest1() throws Exception {
		...
		//close the stream
		bwr.close();
		oPSelFW = new ProlificsSeleniumAPI("WCC", "Create Order WCC2", "Chrome", "Windows 7", "STST", "Automation",
	...
	public void CreateOrderTestClass(HashMap<String, String> XLTestData) throws FileNotFoundException, IOException, InterruptedException
	{
        ...
        prop.load(input);
		LoginPage1 login = new LoginPage1();
		if(!XLTestData.get("TestCaseID").toUpperCase().equals("TC_WCC_33"))
