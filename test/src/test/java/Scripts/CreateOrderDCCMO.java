...
public class CreateOrderDCCMO{
	...
	public static Object[][] createOrderProvider() throws FileNotFoundException, IOException {
		excelReader = new Excel_Reader(System.getProperty("user.dir") + "\\Data\\"+System.getProperty("TestData")+".xlsx");
		return asTwoDimensionalArray();
	}
	
	private static Object[][] asTwoDimensionalArray() throws FileNotFoundException, IOException {
		String TestDataPath = 	System.getProperty("user.dir") + "\\Data\\"+System.getProperty("TestData")+".xlsx";
	...
	public void beforeTest1() throws Exception {
		...
		oPSelFW = new ProlificsSeleniumAPI("WCC", "Create Order DC CMO", "Chrome", "Windows 7", System.getProperty("Environment"), "Automation",
