...
public class CreateOrderWCC{
	...
	private static Object[][] asTwoDimensionalArray() throws FileNotFoundException, IOException {
		...
		Object[][] results = new Object[(RowCount/3)+2][1];
		if(RowCount > 32)
		{
			RowCount = RowCount/3;
		}
	...
	public void beforeTest1() throws Exception {
		...
		//close the stream
		bwr.close();
		oPSelFW = new ProlificsSeleniumAPI("WCC", "Create Order WCC", "Chrome", "Windows 7", "STST", "Automation",
