...
public class BaseReport{
                ...
                public void setUp() throws IOException, ClassNotFoundException, SQLException
                {
                                ...
                                /*for (int i = 0; i < listOfFiles.length; i++) {
                                                ...
                                                {
                                                                File subfolder = new File(System.getProperty("user.dir") +"\\target\\"+ listOfFiles[i].getName());
                                                                File[] FilesList = subfolder.listFiles();
                                ...
                                for (int i = 0; i < listOfFiles.length; i++) {
                                  if (listOfFiles[i].isFile()) {
                                    ...
                                    Path temp = Files.move 
                                            ...
                                            Paths.get(System.getProperty("user.dir") +"//target//Results"+time+"//"+listOfFiles[i].getName())); 
                                  } 
                                }
                }
...
*/           @AfterSuite(alwaysRun=true)
       ...
       //                         try {
        ...
        HTMLContent = HTMLContent + "<tr bgcolor='#BDC3C7'><td><b>Total Count</b></td><td><b>Pass Count</b></td><td><b>Fail Count</b></td></tr>";
        HTMLContent = HTMLContent + "<tr><td>"+Integer.toString(TotalCount)+"</td><td>"+Integer.toString(TestCasePassCount)+"</td><td>"+Integer.toString(TestCaseFailCount)+"</td></tr>";
        //close html file
        HTMLContent = HTMLContent + "</table>";
        HTMLContent = HTMLContent +  "<br>";
        HTMLContent = HTMLContent +  "<br>";
        HTMLContent = HTMLContent + "<table border = 1>";
        HTMLContent = HTMLContent + "<tr bgcolor='#BDC3C7' align='center'><td><b>ScriptName</b></td><td><b>Functional Area</b></td><td><b>PassCount</b></td><td><b>FailCount</b></td><td><b>Failed Steps/Comments</b></td></tr>";
                   ...
                   String ReportName="";
                                try {
                                               ...
                                               BufferedWriter bw = new BufferedWriter(new OutputStreamWriter(fos));
                                                for (int i = 0; i < listOfFiles.length; i++) {
                                                    if (listOfFiles[i].isFile() && listOfFiles[i].getName().contains(".html") && !listOfFiles[i].getName().contains("HTMLEmailableReport") && !listOfFiles[i].getName().contains("index")) {  
                                                    	String getPassCount=""; 
                                                        String getFailCount="";
                                                        ...
                                                        {                            
                                                            ...
                                                            List<String> allLines = Files.readAllLines(Paths.get(System.getProperty("user.dir") +"//target//"+listOfFiles[i].getName()));                   
                                                            for (String line : allLines) {
                                                            	if(line.contains("test-collection"))
                                                                    ...
                                                                    if(CollectionStarted == true && line.contains("/ul"))
                                                                        ...
                                                                        {
                                                                        	getPassCount = StringUtils.substringBetween(line, "<span class='strong'>", "</span> test(s) passed");
                                                                            TestCasePassCount = TestCasePassCount + Integer.parseInt(getPassCount);
                                                                        }
                                                                                                               if(line.contains("test(s) failed"))
                                                                                                               {
                                                                                                                   getFailCount = StringUtils.substring(line, line.indexOf(">")+1, line.indexOf("</span>"));
                                                                                                                   TestCaseFailCount = TestCaseFailCount + Integer.parseInt(getFailCount);
                                                                                                               }
                                                                                                               if(line.contains("report-name'"))
                                                                                                               {
                                                                                                                   ReportName = StringUtils.substringBetween(line, "<span class='report-name'>", "</span>");
                                                                                                               }
                                                                                                               ...
                                                                                                               if(line.contains("step-details") && FailedStepFound == true)
                                                                                                               {
                                                                                                            	   ...
                                                                                                            	   {
                                                                                                            		   failedSteps = failedSteps + StringUtils.substringBetween(line, "<td class='step-details'>", "</td>")+ "<br>";
                                                                                                            	   }
                                                                                                            	   FailedStepFound = false;
                                                                                                               }
                                                                                                               if((line.contains("<div class='left panel-name'>Steps</div>") || line.contains("step(s) failed") || line.contains("step(s) passed")))
                                                                  ...
                                                                  LogString = LogString + "<tr><td>"+ fileName.substring(0, fileName.length()-5) +"</td><td>"+ReportName+"</td><td>"+ getPassCount +"</b></td><td>"+ getFailCount +"</td><td><font color='red'>"+ failedSteps +"</font></td></tr>";
                                                  } }
                                                bw.write("</div>");
                                                bw.write("</div>");
                                                ...
                                                bw.write("<span class='blue-text' status='info' alt='info' title='info'><i class='material-icons'>info_outline</i></span>");
                                                bw.write("<span class='green-text' status='pass' alt='pass' title='pass'><i class='material-icons'>check_circle</i></span>");
                                                bw.write("<span class='red-text' status='fail' alt='fail' title='fail'><i class='material-icons'>cancel</i></span>");
                                                bw.write("<span class='red-text text-darken-4' status='fatal' alt='fatal' title='fatal'><i class='material-icons'>cancel</i></span>");
                                                bw.write("<span class='pink-text text-lighten-1' status='error' alt='error' title='error'><i class='material-icons'>error</i></span>");
                                                bw.write("<span class='orange-text' alt='warning' status='warning' title='warning'><i class='material-icons'>warning</i></span>");
                                                bw.write("<span class='teal-text' status='skip' alt='skip' title='skip'><i class='material-icons'>redo</i></span>");
                                                bw.write("<span status='clear' alt='Clear filters' title='Clear filters'><i class='material-icons'>clear</i></span>");
                                                bw.write("</div>");
                                                bw.write("          </div>");
                                                bw.write("</div>");
                                                ...
                                                bw.write("};");
                                                bw.write("</script>");
                                                bw.write("<script src='https://cdn.rawgit.com/anshooarora/extentreports-java/fca20fb7653aade98810546ab96a2a4360e3e712/dist/js/extent.js' type='text/javascript'></script>");
   ...
   {
                //   LogString = LogString + "<tr><td><b>"+ ScriptName +"</b></td><td><b>"+ PassCount +"</b></td><td><b>"+ FailCount +"</b></td></tr>";
   }
   public void replaceFileCount()
   {
                try
                   ...
                   oldtext = oldtext.replaceAll("##testspassed", Integer.toString(TestCasePassCount/2));
                   oldtext = oldtext.replaceAll("##testsfailed", Integer.toString(TestCaseFailCount/2));
   ...
   public void prepareEmailableReport()
   {
       try{
		...
		//HTMLContent = HTMLContent + "<tr><td bgcolor='#BDC3C7'><b>Time Taken for Order Creation in eComm</b></td></tr><tr><td><b>"+Long.toString(minutues)+ " minutes "+Long.toString(Seconds)+ " seconds "
		//		+"</b></td></tr>";
		//close html file
		//HTMLContent = HTMLContent + "</table>";
		//append row
